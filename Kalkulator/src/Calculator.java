...
public class Calculator implements ActionListener {
    ...
    Calculator() {
        ...
        // Tworzenie i ustawianie pola tekstowego
        ...
        // Dodawanie przycisków funkcyjnych do tablicy
        ...
        // Dodawanie ActionListener do przycisków funkcyjnych
        for (JButton button : functionButtons) {
            button.addActionListener(this);
            button.setFocusable(false);
        }

        // Tworzenie i ustawianie przycisków numerycznych
        for (int i = 0; i < 10; i++) {
        ...
        // Ustawianie przycisków do panelu
